...
// Bonus Points
// const totalByMonth = _.chain(purchasesByMonth)
//   .map(o => o.reduce((acc, curr) => acc + curr))
//   .value(); // Use the grouped purchasesByMonth and reduce to create a totalByMonth object.
